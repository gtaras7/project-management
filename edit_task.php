<?php
/**
 * edit_task.php — HTML form + UPDATE task (UPDATE)
...
<head>
    ...
    <title>Edit Task — DevBoard</title>
    <meta name="description" content="Update an existing task in DevBoard Project Tracker.">
    <style>
...
<div class="card">
    <h1>✏️ Edit Task</h1>
    <p class="subtitle">Editing: <strong style="color:#e2e8f0"><?= htmlspecialchars($task['title']) ?></strong></p>
    ...
    <form method="POST" action="edit_task.php" novalidate>
